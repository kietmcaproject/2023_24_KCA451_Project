...
import Logo2 from "../Image/movix-logo.svg"
...
const Header = () => {
  ...
  return (
    <div className="bg-gradient-to-black from-black absolute w-full z-50 flex justify-between overflow-hidden items-center lg:px-10 md:px-10 sm:px-8 px-4">
      <Link to={"/browse"}>
        <img
